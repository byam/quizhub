...
export class AddQuestionComponent {
  ...
  form = inject(FormBuilder).nonNullable.group({
    ...
    choices: this.formBuilder.array([this.formBuilder.control('')]),
  ...
  submit() {
    ...
    this.courseService
      .addQuestion(this.course_id, this.form.value as IQuestion)
      .subscribe((response) => {
        if (response.success) {
          this.notification.success('Successfully added question!');
